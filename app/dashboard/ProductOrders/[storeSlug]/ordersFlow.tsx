...
async function fetchUsers(params: FetchParams,storeId : number): Promise<FetchParams> {
  ...
  try {
    const response = await fetch(`http://127.0.0.1:3333/admin/orders${queryParams}`, {
      method: 'GET',
      headers: {
...
export default function RoomsPage({storeId}: {hotelId: number}) {
  return (
