...
import { CellAction } from './_compontes/formActions';
...
interface FetchRoomsParams extends FetchParams {
hotelId: number
}

// Fetch users from backend
async function fetchUsers(params: FetchParams,hotelId:number): Promise<FetchRoomsParams> {
  ...
  try {
    const response = await fetch(`http://127.0.0.1:3333/admin/rooms/${hotelId}?${queryParams}`, {
      method: 'GET',
      headers: {
