...
export const getColumns = (t, setRefresh) => [
  ...
  },
  {
    ...
    header: t("orders.info.roomNumber"), // Translated "Hotel Name"
    enableSorting: true,
  },

  {
    accessorKey: "driver.name",
    header: t("drivers.table.name"), // Translated "Room Number"
    enableSorting: true,
    CELL: ({row}) => <>{row.original.driver.name ? row.original.driver.name : "لا يوجد"}</>
  },
  {
    accessorKey: "status",
